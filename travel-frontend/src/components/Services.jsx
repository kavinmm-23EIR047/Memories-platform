  ...
  <div className="bg-[#fffef8] shadow-lg rounded-lg overflow-hidden">
    ...
    <div className="p-4">
      ...
      <button
        ...
        className="block mt-3 bg-[#facc15] text-[#1c1b00] px-4 py-2 rounded hover:bg-[#eab308] transition"
      >
        Explore
      </button>
    </div>
...
const Services = () => {
  ...
  return (
    <section id="services" className="py-12 px-4 md:px-10 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        {/* Section Heading */}
        <h2 className="text-3xl md:text-4xl font-bold text-[#060304] text-center mb-10">
          Our <span className="text-[#fecc00] font-semibold">Services</span>
        </h2>
        ...
        <motion.h2
          ...
          className="text-2xl md:text-3xl font-bold text-[#fdcc00] mb-8 text-center"
        >
          {headingTexts[headingIndex]}{" "}
          <span className="text-[#070000]">Package Details</span>
        </motion.h2>
...
<h2 className="text-2xl md:text-3xl font-bold text-[#060304] mt-16 mb-8 text-center">
  Celebrations <span className="text-[#fecc00] font-semibold">Gallery</span>
</h2>



{/* Mobile Celebrations Swiper */}
<div className="block md:hidden">
  <Swiper
    spaceBetween={10}
    slidesPerView={1}
...
<h2 className="text-2xl md:text-3xl font-bold text-[#060304] mt-16 mb-6 text-center">
  Our <span className="text-[#fecc00] font-semibold">Achievements</span>
</h2>
...
<div className="flex justify-center">
  <div className="relative w-full max-w-md rounded-xl overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300 group">
    ...
    <div className="bg-white p-6">
      <h3 className="text-xl font-semibold text-[#060304] mb-2">
        Record of Munnar – Single Stroke with 90 Jeeps
      </h3>
...
<h2 className="text-2xl md:text-3xl font-bold text-[#060304] mt-16 mb-8 text-center">
  Happy <span className="text-[#fecc00] font-semibold">Moments Gallery</span>
</h2>
